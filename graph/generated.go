...
type MutationResolver interface {
	CreateRecipe(ctx context.Context, input model.CreateRecipeInput) (*model.Response, error)
	UpdateRecipe(ctx context.Context, input model.UpdateRecipeInput) (*model.Response, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Response.recipe":
		if e.complexity.Response.Recipe == nil {
			break
		}
...
func (ec *executionContext) field_Mutation_createRecipe_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNCreateRecipeInput2githubᚗcomᚋDanteMichaeliᚋCookBookAPIᚋgraphᚋmodelᚐCreateRecipeInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_updateRecipe_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalNUpdateRecipeInput2githubᚗcomᚋDanteMichaeliᚋCookBookAPIᚋgraphᚋmodelᚐUpdateRecipeInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Response_recipe(ctx context.Context, field graphql.CollectedField, obj *model.Response) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Response_recipe(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) unmarshalInputCreateRecipeInput(ctx context.Context, obj interface{}) (model.CreateRecipeInput, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "id":
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("id"))
			data, err := ec.unmarshalNRecipeID2string(ctx, v)
			if err != nil {
				return it, err
			}
			it.ID = data
...
func (ec *executionContext) unmarshalNCreateRecipeInput2githubᚗcomᚋDanteMichaeliᚋCookBookAPIᚋgraphᚋmodelᚐCreateRecipeInput(ctx context.Context, v interface{}) (model.CreateRecipeInput, error) {
...
func (ec *executionContext) unmarshalNUpdateRecipeInput2githubᚗcomᚋDanteMichaeliᚋCookBookAPIᚋgraphᚋmodelᚐUpdateRecipeInput(ctx context.Context, v interface{}) (model.UpdateRecipeInput, error) {
